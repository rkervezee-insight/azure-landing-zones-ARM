...
August 12, 2021 1.0   
  ...
  .DESCRIPTION
    This script moves the Platorm Identity Subscription to the appropriate Management Group, use this if you want to only deploy this component only.
#>
...
$DeploymentName = "movePlatformIdentitySub"
